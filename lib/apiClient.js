...
//   - default export: a ready-to-use singleton "apiClient"
//   - named export:  APIClient  (alias of SportsDataIOClient class)
//   - named export:  SportsDataIOClient (class)
//   - named export:  apiClient (same singleton as default)
...
export class SportsDataIOClient {
  constructor(opts = {}) {
    ...
    this.baseURL =
      (opts.baseURL ||
        ...
        "https://api.sportsdata.io").replace(/\/+$/, "");
  ...
  // (optional) Projections, if your plan supports them
  ...
  // NFL by-week helpers (for recents)
...
export { SportsDataIOClient as APIClient }; // <-- backward-compatible alias
export { SportsDataIOClient };
