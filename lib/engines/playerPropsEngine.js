...
export class PlayerPropsEngine {
  constructor(apiClient) {
    ...
    this.calibrationScale = 1.0; // simple scaler; can be tuned later
  }
  ...
  // ===== SMART OVERLAYS (all guarded; never throw) =====
  ...
  calibrationScale(prob) { return prob * this.calibrationScale; }
